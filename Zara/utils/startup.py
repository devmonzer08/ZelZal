    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/8ad82358221191a9dd096.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس سيࢪ࣪ࢪ❤️‍🩹 الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝙨𝙚𝙯𝙖𝙧𓅛", "https://t.me/UIU_II"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "sezar")
...
Zara = {"@UIU_II", "@Zed_Thon", "@zzzvrr", "@zzzlvv"}
async def saves():
   for Cat in Zara:
        try:
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "جروب السجـل سيزر", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
