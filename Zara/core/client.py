            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع سيࢪ࣪ࢪ❤️‍🩹 𝙨𝙚𝙯𝙖𝙧--------"
                        ...
                        link = "[𐇮 ⧛ 𝖕𝖔𝖐𝖊𝖒𝖔𝖓 ׀ 𝗝َ َ𝗢َ ٍ𝗞َ〡مّـمٌَــ ـؤِلًُ ⧚ ❲𝙫𝙞𝙥❳𐇮](https://t.me/devpokemon)"
                        text = (
                            "**✘ تقـريـر اشعـار سيࢪ࣪ࢪ❤️‍🩹 𝙨𝙚𝙯𝙖𝙧 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار سيࢪ࣪ࢪ❤️‍🩹 𝙨𝙚𝙯𝙖𝙧 ✘**\n\n "
                        link = "[𐇮 ⧛ 𝖕𝖔𝖐𝖊𝖒𝖔𝖓 ׀ 𝗝َ َ𝗢َ ٍ𝗞َ〡مّـمٌَــ ـؤِلًُ ⧚ ❲𝙫𝙞𝙥❳𐇮](https://t.me/devpokemon)"
