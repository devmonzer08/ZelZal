...
joker_users = []
joker_mute = "https://telegra.ph/file/80811c8d93b14e6d063ae.jpg"
joker_unmute = "https://telegra.ph/file/0b7720f4f67544180cd67.jpg"
#=================== الكـــــــــــــــتم  ===================  #

@zedub.zed_cmd(pattern=f"كتم(?:\s|$)([\s\S]*)")
...
@zedub.zed_cmd(pattern=f"(الغاء كتم|ارغي)(?:\s|$)([\s\S]*)")
...
@zedub.zed_cmd(pattern=r"قائمة المكتومين")
