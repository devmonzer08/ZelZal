...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 6300938349 or user.id == 6300938349 or user.id == 6300938349:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6300938349 or user.id == 1895219306 or user.id == 2095357462:
...
async def catgkick(event):  # sourcery no-metrics
    ...
    if user.id == 6300938349 or user.id == 1050898456 or user.id == 627658332:
