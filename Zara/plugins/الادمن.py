...
async def _ban_person(event):
    ...
    if user.id == 5652812673 or user.id == 1050898456 or user.id == 627658332:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 5652812673 or event.chat_id == 1050898456 or event.chat_id == 627658332:
