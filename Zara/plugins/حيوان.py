...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗦𝗘𝗭𝗔𝗥 𓆪 </b> - @UIU_II "
...
async def who(event):
    ...
    if replied_user.id == 6300938349 or replied_user.id == 627658332 or replied_user.id == 6300938349:
