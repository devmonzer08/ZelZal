...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 - اوامـر الصيـد والتشيكـر](t.me/KK_DV) 𓆪\n\n"
...
ZelzalType_cmd = (
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 - أنـواع اليـوزرات](t.me/KK_DV) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ صيـد كــابــوس 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 ⎉",
                    about="This channel to hunt username by - @KK_DV ",
                )
            )
...
async def _(event):
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ تثبيت كــابــوس 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 ⎉",
                about="تم تثبيت اليـوزر بواسطـة سـورس كــابــوس - @KK_DV ",
            )
        )
        ch = ch.updates[1].channel_id
