...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗘𝗮𝗗𝗲𝗥 - اوامـر الصيـد والتشيكـر](t.me/V_P_N_8) 𓆪\n\n"
    ...
    "**- انضـم للقنـاة ~ @V_P_N_8**\n"
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن زدثــون**\n\n"
)

ZelzalType_cmd = (
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗘𝗮𝗗𝗲𝗥 - أنـواع اليـوزرات](t.me/V_P_N_8) 𓆪\n\n"
...
async def _(event):
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ تثبيت ســـيزر 𝗟𝗘𝗮𝗗𝗲𝗥 ⎉",
                about="تم تثبيت اليـوزر بواسطـة سـورس ســـيزر - @V_P_N_8 ",
            )
        )
        ch = ch.updates[1].channel_id
