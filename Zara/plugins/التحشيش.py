...
zed_dev = (1283542711, 5176749470, 2095357462)
...
async def ge(user, event):
    ...
    try:
        ...
        return None
    return user_obj
########################  KK_DV Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedub.zed_cmd(pattern="رابط الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/KK_DV) 🗑♻️𓆪\n**𓍹━─━─━─━─𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف¹  ↬** @LC6BOT\n**✵│بـوت الحـذف²  ↬** @DTeLebot")
########################  KK_DV Userbot ~ By: Zelzal (@zzzzl1l)  ########################
...
########################  KK_DV Userbot ~ By: Zelzal (@zzzzl1l)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/KK_DV) 𓆪\n\n"
