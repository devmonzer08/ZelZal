...
zed_dev = (5055859931, 627658332, 5190136458, 1050898456, 5652812673)
zel_dev = (5055859931, 5652812673)
zelzal = (5190136458)
...
# الـرتب الوهميـه & فارات الكليشـه & البريميـوم كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    if user_id in zelzal: #Code by T.me/zzzzl1l
        ...
        rotbat = "⌁ العضـو 𓅫 ⌁"
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت سـٰٖـ๋͜ــيزًࢪ❤️‍🩹" 
