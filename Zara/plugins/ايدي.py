...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت سيزر"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "𖣐 "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⧛ ⋖≔𖣥≕✯𝐒 𝐄 𝐙 𝐀 𝐑✯≔𖣥≕⋗ ⧚"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    zed_dev = (627658332, 1050898456, 5055859931)
    zel_dev = (5190136458, 5055859931, 5652812673)
    if user_id == 5190136458 or user_id == 5652812673 or user_id == 5055859931:
