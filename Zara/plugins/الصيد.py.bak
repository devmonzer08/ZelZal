...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗦𝗘𝗭𝗔𝗥 - اوامـر الصيـد والتشيكـر](t.me/UIU_II) 𓆪\n\n"
...
ZelzalType_cmd = (
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗦𝗘𝗭𝗔𝗥 - أنـواع اليـوزرات](t.me/UIU_II) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ صيـد ســـيزر 𝗦𝗘𝗭𝗔𝗥 ⎉",
                    about="This channel to hunt username by - @UIU_II ",
                )
            )
...
async def _(event):
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ تثبيت ســـيزر 𝗦𝗘𝗭𝗔𝗥 ⎉",
                about="تم تثبيت اليـوزر بواسطـة سـورس ســـيزر - @UIU_II ",
            )
        )
        ch = ch.updates[1].channel_id
