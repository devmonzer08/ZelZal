...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 5593884330 or user.id == 6301863282 or user.id == 6033155844:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 5593884330 or user.id == 5578760481 or user.id == 6301863282:
