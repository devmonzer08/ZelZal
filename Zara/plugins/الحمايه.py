...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 1283542711 or event.chat_id == 1895219306 or event.chat_id == 2095357462 or event.chat_id == 5280339206:
