...
async def on_new_private_message(event):
    ...
    zel_dev = (5593884330, 6033155844,5578760481)
    ...
    if event.chat_id == 5593884330 or event.chat_id == 6301863282 or event.chat_id == 6033155844 or event.chat_id == 5593884330:
