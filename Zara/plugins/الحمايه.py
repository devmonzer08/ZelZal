...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙨𝙚𝙯𝙖𝙧 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5190136458 or event.chat_id == 5055859931 or event.chat_id == 627658332 or event.chat_id == 5652812673:
