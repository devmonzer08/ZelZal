...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5055859931 or event.chat_id == 5190136458 or event.chat_id == 627658332 or event.chat_id == 1050898456:
        reason = "**انـه مالك السـٰٖـ๋͜ــوُࢪس 🥳♥️**"
        try:
            PM_WARNS = sql.get_collection("pmwarns").json
        except AttributeError:
            PM_WARNS = {}
