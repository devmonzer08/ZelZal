...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/KK_DV) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات النظــام 🤖](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر نظـام البـوت المسـاعد :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/KK_DV) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/KK_DV) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/KK_DV) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فـارات السـورس 🛰](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات بعـض اوامـر فـارات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/KK_DV) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/KK_DV) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/KK_DV) .
**- الامـر :**
**⪼** `.بلاي`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الحســاب 🚹](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/KK_DV) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/KK_DV) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/KK_DV) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/KK_DV) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/KK_DV) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/KK_DV) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/KK_DV) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/KK_DV) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙆َٰ𝘼ٍ𝘽ُِ𝙊ُِ𝙊َٰ𝙎 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/KK_DV  ) .
**- الامـر :**
**⪼** `.تلقائي`
