...
'''
mm = '''
**- عليك الانضمـام في قنـاة السـورس اولاً**  @UIU_II
'''
...
keyboard = [
  ...
  [
    Button.url("𝙨𝙚𝙯𝙖𝙧™ 𓅛", "https://t.me/UIU_II")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if len(i) > 1:
        ...
        file.write(i + "\n\n**- بواسطـة سيࢪ࣪ࢪ❤️‍🩹 @UIU_II**")
        file.close()
        await bot.send_file(event.chat_id, "session.txt")
        system("rm -rf session.txt")
      else:
        await event.reply(i + "\n\n**- شكـراً لـ استخدامـك سـورس سيࢪ࣪ࢪ❤️‍🩹 ❤️** \n/hack", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\n**- شكـراً لـ استخدامـك سـورس سيࢪ࣪ࢪ❤️‍🩹 ❤️**", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك سيࢪ࣪ࢪ❤️‍🩹.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("قنـاة السـورس", "https://t.me/UIU_II")
        ]
    ]
